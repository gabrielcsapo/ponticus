      ...
      suite("Functions", () => {
        suite("generator functions:", () => {
          ...
          test("method names are correct", () => {
            ...
            assert.strictEqual(
              JSON.stringify(report.methods[0].paramNames),
              '["param1"]'
            );
          });
      ...
      suite("Expressions", () => {
        suite("CallExpression (super):", () => {
          ...
          test("class method names are correct", () => {
            assert.strictEqual(
              report.classes[1].methods[0].name,
              "constructor"
            );
          ...
          test("class method has correct Halstead vocabulary", () => {
            assert.strictEqual(
              report.classes[1].methods[0].halstead.vocabulary,
              2
            );
          });
          ...
          test("class method has correct Halstead difficulty", () => {
            assert.strictEqual(
              report.classes[1].methods[0].halstead.difficulty,
              1
            );
          });
          ...
          test("class method has correct Halstead bugs", () => {
            assert.strictEqual(
              report.classes[1].methods[0].halstead.bugs,
              0.001
            );
          });
          ...
          test("class method has correct Halstead time", () => {
            assert.strictEqual(
              report.classes[1].methods[0].halstead.time,
              0.111
            );
          });
        ...
        suite("MemberExpression (super):", () => {
          ...
          test("class method names are correct", () => {
            assert.strictEqual(
              report.classes[0].methods[0].name,
              "constructor"
            );
          ...
          test("class method has correct Halstead vocabulary", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.vocabulary,
              5
            );
          });
          ...
          test("class method has correct Halstead difficulty", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.difficulty,
              1.5
            );
          });
          ...
          test("class method has correct Halstead volume", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.volume,
              11.61
            );
          });
          ...
          test("class method has correct Halstead effort", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.effort,
              17.414
            );
          });
          ...
          test("class method has correct Halstead bugs", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.bugs,
              0.004
            );
          });
          ...
          test("class method has correct Halstead time", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.time,
              0.967
            );
          });
          ...
          test("class method has correct Halstead volume", () => {
            assert.strictEqual(
              report.classes[1].methods[0].halstead.volume,
              15.51
            );
          });
          ...
          test("class method has correct Halstead effort", () => {
            assert.strictEqual(
              report.classes[1].methods[0].halstead.effort,
              31.02
            );
          });
      ...
      suite("Classes", () => {
        suite("class declaration:", () => {
          ...
          test("class aggregate has correct Halstead total operators", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.operators.total,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead total operands", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.operands.total,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead distinct operands", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.operands.distinct,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead vocabulary", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.vocabulary,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead difficulty", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.difficulty,
              0
            );
          });
        ...
        suite("class declaration with super class (member expression):", () => {
          ...
          test("class names are correct", () => {
            assert.strictEqual(report.classes[0].name, "Foo");
            assert.strictEqual(
              report.classes[0].superClassName,
              "<computed~Bar.Baz>"
            );
          });
        ...
        suite("class declaration w/ superclass:", () => {
          ...
          test("class aggregate has correct Halstead total operators", () => {
            ...
            assert.strictEqual(
              report.classes[1].aggregate.halstead.operators.total,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead total operands", () => {
            ...
            assert.strictEqual(
              report.classes[1].aggregate.halstead.operands.total,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead distinct operands", () => {
            ...
            assert.strictEqual(
              report.classes[1].aggregate.halstead.operands.distinct,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead vocabulary", () => {
            ...
            assert.strictEqual(
              report.classes[1].aggregate.halstead.vocabulary,
              0
            );
          });
          ...
          test("class aggregate has correct Halstead difficulty", () => {
            ...
            assert.strictEqual(
              report.classes[1].aggregate.halstead.difficulty,
              0
            );
          });
        ...
        suite("class declaration w/ constructor:", () => {
          ...
          test("class has correct Halstead volume", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.volume,
              19.651
            );
          });
          ...
          test("class has correct Halstead effort", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.effort,
              29.477
            );
          });
          ...
          test("class has correct Halstead bugs", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.bugs,
              0.007
            );
          });
          ...
          test("class has correct Halstead time", () => {
            assert.strictEqual(
              report.classes[0].aggregate.halstead.time,
              1.638
            );
          });
          ...
          test("class methods has correct Halstead total operators", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.operators.total,
              3
            );
          });
          ...
          test("class methods has correct Halstead total operands", () => {
            assert.strictEqual(
              report.classes[0].methods[0].halstead.operands.total,
              2
            );
          });
        ...
        suite(
          ...
          () => {
            ...
            test("class aggregate has correct Halstead length", () => {
              assert.strictEqual(
                report.classes[0].aggregate.halstead.length,
                14
              );
            });
            ...
            test("class methods has correct Halstead length", () => {
              assert.strictEqual(
                report.classes[0].methods[0].halstead.length,
                10
              );
            });
        ...
        suite(
          ...
          () => {
            ...
            test("module methods has correct Halstead distinct operators", () => {
              assert.strictEqual(
                report.methods[0].halstead.operators.distinct,
                6
              );
              assert.strictEqual(
                report.methods[1].halstead.operators.distinct,
                2
              );
            });
            ...
            test("module methods has correct Halstead distinct operands", () => {
              assert.strictEqual(
                report.methods[0].halstead.operands.distinct,
                4
              );
              assert.strictEqual(
                report.methods[1].halstead.operands.distinct,
                1
              );
            });
            ...
            test("class method names are correct", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].name,
                "<anon method-2>"
              );
            ...
            test("class methods has correct Halstead total operators", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.operators.total,
                1
              );
            });
            ...
            test("class methods has correct Halstead total operands", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.operands.total,
                1
              );
            });
            ...
            test("class methods has correct Halstead length", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.length,
                2
              );
            });
            ...
            test("class methods has correct Halstead vocabulary", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.vocabulary,
                2
              );
            });
            ...
            test("class methods has correct Halstead difficulty", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.difficulty,
                0.5
              );
            });
            ...
            test("class methods has correct Halstead volume", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.volume,
                2
              );
            });
            ...
            test("class methods has correct Halstead effort", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.effort,
                1
              );
            });
            ...
            test("class methods has correct Halstead bugs", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.bugs,
                0.001
              );
            });
            ...
            test("class methods has correct Halstead time", () => {
              ...
              assert.strictEqual(
                report.classes[0].methods[1].halstead.time,
                0.056
              );
            });
