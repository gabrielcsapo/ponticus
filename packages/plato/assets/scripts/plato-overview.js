...
$(function() {
  ...
  function drawOverviewCharts(reports) {
    ...
    var charts = [];
    if (document.getElementById(bugs.element)) { charts.push(Morris.Bar(bugs)); }
    if (document.getElementById(sloc.element)) { charts.push(Morris.Bar(sloc)); }
    if (document.getElementById(maintainability.element)) { charts.push(Morris.Bar(maintainability)); }

    if (__options.flags.eslint && document.getElementById(lint.element)) {charts.push(Morris.Bar(lint));}
