  ...
  casper.then(function () {
    casper.waitForSelector("span.js-file-chart", function () {
      casper.test.assertEvalEquals(
        ...
        "complexity",
        '"complexity" is first entry in "metrics" list'
      );
      ...
      casper.test.assertEvalEquals(
        ...
        "sloc",
        '"sloc" is second entry in "metrics" list'
      );
    });
  });
  ...
  casper.then(function () {
    casper.waitForSelector("span.js-file-chart", function () {
      casper.test.assertEvalEquals(
        ...
        "sloc",
        '"sloc" is first entry in "metrics" list'
      );
      ...
      casper.test.assertEvalEquals(
        ...
        "complexity",
        '"complexity" is second entry in "metrics" list'
      );
