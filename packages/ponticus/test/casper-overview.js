...
casper.start("./tmp/index.html", function () {
  ...
  this.test.assertEvalEquals(
    ...
    2,
    "Has appropriate number list items in the file list"
  );
  ...
  this.test.assertEval(function () {
    return (
      document.querySelectorAll(".plato-file-chart").length ===
      document.querySelectorAll(".plato-file-chart svg").length
    );
