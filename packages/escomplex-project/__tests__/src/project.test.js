...
*/
        ...
        expect(result.modules[8].srcPath).toBe(
          "escomplex-commons/src/module/report/AggregateMethodReport.js"
        );
        ...
        expect(result.modules[44].srcPath).toBe(
          "escomplex-module/src/ESComplexModule.js"
        );
        expect(result.modules[45].srcPath).toBe(
          "escomplex-module/src/index.js"
        );
        expect(result.modules[46].srcPath).toBe(
          "escomplex-module/src/Plugins.js"
        );

        expect(result.modules[45].srcPathAlias).toBe("escomplex-module");
      });
