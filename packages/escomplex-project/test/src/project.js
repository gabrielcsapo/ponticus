    ...
    suite(`(${Parser.name}) project:`, () => {
      ...
      suite("no modules:", () => {
        ...
        test("mean per-function logical LOC is correct", () => {
          assert.strictEqual(
            result.moduleAverage.methodAverage.sloc.logical,
            0
          );
        });
        ...
        test("mean per-function Halstead effort is correct", () => {
          assert.strictEqual(
            result.moduleAverage.methodAverage.halstead.effort,
            0
          );
        });
      ...
      suite("one module:", () => {
        ...
        test("first module aggregate has correct Halstead total operators", () => {
          assert.strictEqual(
            result.modules[0].aggregate.halstead.operators.total,
            2
          );
        });
        ...
        test("first module aggregate has correct Halstead total operands", () => {
          assert.strictEqual(
            result.modules[0].aggregate.halstead.operands.total,
            3
          );
        });
        ...
        test("first module aggregate has correct Halstead vocabulary", () => {
          assert.strictEqual(
            result.modules[0].aggregate.halstead.vocabulary,
            5
          );
        });
        ...
        test("first module aggregate has correct Halstead difficulty", () => {
          assert.strictEqual(
            result.modules[0].aggregate.halstead.difficulty,
            1
          );
        });
        ...
        test("first module aggregate has correct Halstead volume", () => {
          assert.strictEqual(
            result.modules[0].aggregate.halstead.volume,
            11.61
          );
        });
        ...
        test("first module aggregate has correct Halstead effort", () => {
          assert.strictEqual(
            result.modules[0].aggregate.halstead.effort,
            11.61
          );
        });
      ...
      suite("two modules with different options:", () => {
        ...
        test("should have default values if we call with skipCalculation", () => {
          ...
          assert.strictEqual(
            reportsOnly.moduleAverage.methodAverage.sloc.logical,
            0
          );
      ...
      suite(
        ...
        () => {
          ...
          test("adjacency list is correct", () => {
            ...
            assert.strictEqual(
              JSON.stringify(result.adjacencyList),
              testString
            );
          });
          ...
          test("visibility list is correct", () => {
            ...
            assert.strictEqual(
              JSON.stringify(result.visibilityList),
              testString
            );
          });
        }
