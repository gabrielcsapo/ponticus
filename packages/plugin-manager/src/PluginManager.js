...
export default class PluginManager {
  ...
  destroy() {
    ...
    if (this._eventbus !== null && typeof this._eventbus !== "undefined") {
      ...
      this._eventbus.off(
        `${this._eventPrepend}:add:all`,
        this._addAllEventbus,
        this
      );
      this._eventbus.off(
      ...
      this._eventbus.off(
        `${this._eventPrepend}:get:options`,
        this.getOptions,
        this
      );
      this._eventbus.off(
      ...
      this._eventbus.off(
        `${this._eventPrepend}:has:method`,
        this.hasMethod,
        this
      );
      this._eventbus.off(
        `${this._eventPrepend}:has:plugin`,
        this.hasPlugin,
        this
      );
      this._eventbus.off(
      ...
      this._eventbus.off(
        `${this._eventPrepend}:remove`,
        this._removeEventbus,
        this
      );
      this._eventbus.off(
      ...
      this._eventbus.off(
        `${this._eventPrepend}:sync:invoke`,
        this.invokeSync,
        this
      );
      this._eventbus.off(
